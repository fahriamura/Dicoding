...
import com.example.dicoding.databinding.ActivitySplashyBinding

internal class SplashyActivity : AppCompatActivity() {
    lateinit var binding: ActivitySplashyBinding
        ...
        if (intent.hasExtra(ANIMATION_TYPE)) {
            ...
            when (intent.getSerializableExtra(ANIMATION_TYPE)) {
                ...
                Splashy.Animation.SLIDE_IN_TOP_BOTTOM -> {
                    ...
                    binding.ivLogo.animation.setAnimationListener(object : Animation.AnimationListener {
